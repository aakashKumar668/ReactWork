  ...
  return (
    <>
      <div className='w-full'>
        <div className='w-full bg-[#03031cd6] px-[50px] sm:py-[20px] py-[10px]'><h1 className='text-white sm:text-6xl text-2xl font-bold'>Time Table for 2025</h1></div>
          ...
          <div className='z-[10] w-full m-auto sm:py-[60px] sm:px-[100px] bg-[#000000ba] px-[10px] py-[20px] sm:h-auto'>
            ...
            <div className='sm:w-[50%] w-full sm:px-[100px] px-[20px] text-gray-300'>
              <div className='cursor-pointer'>
                <h4 className='text-white underline text-xl font-bold list-outside'>Time Table For First Year</h4>
                <ol className='list-[circle] text-[15px] text-green-400 font-[500]'>
                  {
                ...
                <h4 className='text-white underline text-xl font-bold list-outside'>Time Table For Second Year</h4>
                <ol className='list-[circle] text-[15px] text-red-400 font-[500]'>
                  {
                ...
                <h4 className='text-white underline text-xl font-bold list-outside'>Time Table For Third Year</h4>
                <ol className='list-[circle] text-[15px] text-gray-400 font-[500]'>
                  {
                    Programme[0].graduateCourses.map((item, i) =>
                    {
                      return (
