    ...
    <>
      ...
      <>
        <div className='w-full'>
          <div className='w-full bg-[#03031cd6] px-[50px] sm:py-[20px] py-[10px]'><h1 className='text-white sm:text-6xl text-2xl font-bold'>History</h1></div>
          <div className=' relative overflow-hidden'>
            ...
            <div className='z-[10] w-full m-auto sm:py-[60px] sm:px-[100px] bg-[#000000ba] px-[30px] py-[20px] h-[35vh] sm:h-auto overflow-scroll sm:overflow-hidden'>
              <h1 className='text-white sm:text-8xl font-bold sm:mx-[100px] sm:my-[50px] text-2xl mb-6'>History of college</h1>
