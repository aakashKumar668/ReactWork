...
const Photos = () => {
  return (
    ...
    <div className='w-full bg-white '>
        <div className='w-full bg-[#03031cd6] px-[50px] sm:py-[20px] py-[10px]'><h1 className='text-white sm:text-6xl text-2xl font-bold'>Photos</h1></div>
...
{/* <div className=' bg-red-600 w-[30%] inline-grid justify-items-center py-[50px]'>
<img src={student} alt="" className='w-full rounded h-[250px]' />
<div className='flex w-[95%] my-[20px] justify-start px-[10px]'>
  <h2 className='text-4xl font-bold  text-green-400 w-[50px] inline-grid'>18<span className='text-gray-400 text-[20px]  border-b-[4px] border-green-400 text-center'>APR</span></h2>
  <p className='text-center text-[20px] font-bold mx-[10px] text-green-400'>University day</p>
</div>
</div> */}